...
export default function ConfusionMatrixPlot() {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 rounded-xl shadow-lg overflow-x-auto relative" style={{ backgroundColor: palette.background, border: `1px solid ${palette.gridLines}` }}>
      <HelpPopup
        title="Confusion Matrix"
        whatItDoes="Evaluates trading signals (BUY/SELL) generated by RSI against actual stock outcomes. Shows how often signals were correct or incorrect."
        whyItMatters="Helps assess whether a trading strategy actually works. Shows the accuracy and types of errors (false positives vs false negatives) to improve signal generation."
        whoItMattersFor="Traders testing and refining their technical analysis strategies."
        howToRead="Green cells = correct predictions. Red cells = incorrect predictions. Row = predicted signal, Column = actual outcome. Overall Accuracy shows percentage of correct signals."
      />
